...
Explore
 ...
 Sign out
 Watch 0
  Star 0  Fork 0 kathleenrego/OBR_R3-D3
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Insights  Settings
Branch: master Find file Copy pathOBR_R3-D3/OFICIAL_ino.ino
9ea8dd7  just now
@kathleenrego kathleenrego Add files via upload
1 contributor
RawBlameHistory     
806 lines (700 sloc)  18.4 KB
#include <Servo.h> 
Servo motorELE;
Servo motorFEC;
